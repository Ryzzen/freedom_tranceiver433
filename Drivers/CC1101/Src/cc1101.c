...
static HAL_StatusTypeDef CC1101_ReadReg(CC1101_HandleTypeDef *this,
  ...
  /* uint8_t header = size <= 1 ? CC1101_READ(address) :
   * CC1101_READ_BURST(address); */
  ...
  HAL_StatusTypeDef status =
      HAL_SPI_Receive(this->hspi, buf, size, CC1101_SPI_DELAY);
...
static HAL_StatusTypeDef CC1101_WriteReg(CC1101_HandleTypeDef *this,
  ...
  HAL_StatusTypeDef status;
  /* uint8_t header = (data && size) ? (size <= 1) ? CC1101_WRITE(address) :
   * CC1101_WRITE_BURST(address) : address; */
...
static HAL_StatusTypeDef CC1101_WriteData(CC1101_HandleTypeDef *this,
